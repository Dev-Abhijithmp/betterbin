              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (value) =>
                        KeyClass.registerFormKey.currentState?.validate(),
                    validator: (value) {
                      if (value!.length < 6) {
                ...
                InkWell(
                  onTap: () async {
                    if (KeyClass.registerFormKey.currentState!.validate()) {
                        ...
                        if (controllerpass.text == controllerpass1.text) {
                          ...
                          showDialog(
                              ...
                              builder: (context) => alert(
                                  "Error", "passwords didnt match", context));
                        }
                      }
                    }
                  },
